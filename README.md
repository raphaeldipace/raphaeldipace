...
">
  ...
  <!-- Python -->
  <div style="background-color: #111; border-radius: 14px; padding: 20px; width: 100px; text-align: center; box-shadow: 0 0 15px rgba(255,68,68,0.25);">
  ...
  <div style="background-color: #111; border-radius: 14px; padding: 20px; width: 100px; text-align: center; box-shadow: 0 0 15px rgba(255,68,68,0.25);">
    ...
    <div style="color:#FF4444; font-weight:bold; margin-top:10px;">JS</div>
  </div>
  ...
  <!-- Verilog -->
  <div style="background-color: #111; border-radius: 14px; padding: 20px; width: 100px; text-align: center; box-shadow: 0 0 15px rgba(255,68,68,0.25);">
    <div style="width: 50px; height: 50px; background: black; border-radius: 6px; margin: auto; display: flex; align-items: center; justify-content: center;">
